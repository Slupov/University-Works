        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2019, 1, 12, 13, 30, 54, 485, DateTimeKind.Local)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransportationPrice = table.Column<decimal>(nullable: false),
                    AccomodationPrice = table.Column<decimal>(nullable: false),
                    AdventuresPrice = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TourPackages", x => new { x.Destination, x.Name });
                });
